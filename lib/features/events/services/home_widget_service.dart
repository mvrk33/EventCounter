...
class WidgetKeys {
  ...
  static const String cfgCountUnit =
      'wcfg_count_unit'; // 'days' | 'months' | 'years'
  ...
  Future<void> pushPendingEventWidget({
    ...
    try {
      ...
      await HomeWidget.saveWidgetData<int>(
          WidgetKeys.pendingCountNum, d.countNum);
      await HomeWidget.saveWidgetData<String>(
          WidgetKeys.pendingCountUnit, d.countUnit);
      await HomeWidget.saveWidgetData<String>(
          WidgetKeys.pendingCountDir, d.countDir);
      await HomeWidget.saveWidgetData<String>(WidgetKeys.pendingEmoji, d.emoji);
      await HomeWidget.saveWidgetData<bool>(
          WidgetKeys.pendingTransparent, transparent);
      await HomeWidget.saveWidgetData<String>(
          WidgetKeys.pendingBgColor, _colorToHex(bgColor));
      await HomeWidget.saveWidgetData<bool>(
          WidgetKeys.pendingShowEmoji, showEmoji);
      await HomeWidget.saveWidgetData<bool>(
          WidgetKeys.pendingShowTitle, showTitle);
      await HomeWidget.saveWidgetData<String>(
          WidgetKeys.pendingTextColor, _colorToHex(textColor));
    } catch (_) {}
  }
